<article class="card border-0 shadow-sm h-100">
	<div class="position-relative">
		...
		@if($obj->hasFeatured())
			@include('_img.lazy', ['lzobj' => $obj->featured, 'lzw' => 1280, 'lzh' => 960, 'ar' => '4by3', 'cl' => 'card-img-top'])
		@else
			@include('_img.placeholder', ['phw' => 800, 'phh' => 600, 'phar' => '4by3', 'phbg' => 'e8ecf0', 'phcol' => 'd4d8dc'])
		@endif
	</div>

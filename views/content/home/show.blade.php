...
@section('content')
		...
		<section class="container my-48 py-lg-48 py-md-24 py-16">
			<div class="row gy-4 py-xl-16">
				@if($data->object->hasFeatured())
					<div class="col-md-6">
						@include('_img.lazy', ['lzobj' => $data->object->featured, 'lzw' => 1280, 'lzh' => 960, 'ar' => '4x3', 'cl' => 'rounded-3 shadow-sm'])
					</div>
	...
	<section class="container my-48 py-lg-48 py-md-24 pt-8 pb-16">
		@widget('entityCacheWidget', ['entity_key' => 'service', 'parent' => 'home', 'term' => '', 'needs_image' =>
	...
	<section class="container mb-48 pt-72 pb-lg-48 pb-md-24 pb-16">
		<div class="mb-xl-16">
			@widget('entityCacheWidget', ['entity_key' => 'testimonial', 'parent' => 'home', 'term' => 'home',
			'needs_image'
			=> true, 'count' => 3, 'grid' => $data->grid])
		</div>
	</section>
	...
	<section class="bg-secondary border-bottom border-light py-48">
		<div class="container py-md-16 py-lg-48">
			@widget('entityCacheWidget', ['entity_key' => 'blog', 'parent' => 'home', 'term' => 'home-blog-widget',
